...
namespace Portfolio.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,name,senderEmail,sendTime,message")] Contact contact)
        {
            ...
            myMessage.From = new MailAddress(contact.SenderEmail, contact.Name);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,SenderEmail,SendTime,Message")] Contact contact)
        {
            if (ModelState.IsValid)
            {
